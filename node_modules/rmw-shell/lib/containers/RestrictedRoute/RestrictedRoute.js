...
var RestrictedRoute = function RestrictedRoute(_ref) {
  ...
  return _react2.default.createElement(_reactRouter.Route, _extends({}, rest, { render: function render(props) {
      return isAuthorised && type === 'private' || !isAuthorised && type === 'public' ? _react2.default.createElement(Component, props) : _react2.default.createElement(_reactRouter.Redirect, { to: {
