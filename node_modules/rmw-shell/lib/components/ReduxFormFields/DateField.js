...
var DateField = function (_Component) {
  ...
  function DateField(props) {
    ...
    _this.handleDateTextBlur = function (state, e) {
      ...
      _this.setState({ value: (0, _dateTime.formatDateToString)(newVal, format) });
      change(name, (0, _dateTime.formatDateToObject)(newVal, format).toISOString());
    };
...
DateField.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  datePickerText: _propTypes2.default.string.isRequired,
  muiTheme: _propTypes2.default.object.isRequired,
  intl: _reactIntl.intlShape.isRequired
} : {};

exports.default = (0, _muiThemeable2.default)()((0, _reactIntl.injectIntl)(DateField));
